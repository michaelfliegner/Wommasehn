...
# !!! Main.UserApp is configured as an alias for Main.Wommasehn and you might encounter it in some tests
using Main.Wommasehn, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Wommasehn tests" begin
  @includetests ARGS
end
